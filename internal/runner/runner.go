...
import (
	...
	"github.com/kiokuless/nuclei/v3/internal/pdcp"
	"github.com/kiokuless/nuclei/v3/pkg/authprovider"
	"github.com/kiokuless/nuclei/v3/pkg/fuzz/frequency"
	"github.com/kiokuless/nuclei/v3/pkg/input/provider"
	"github.com/kiokuless/nuclei/v3/pkg/installer"
	"github.com/kiokuless/nuclei/v3/pkg/loader/parser"
	"github.com/kiokuless/nuclei/v3/pkg/scan/events"
	...
	"github.com/kiokuless/nuclei/v3/internal/colorizer"
	"github.com/kiokuless/nuclei/v3/internal/httpapi"
	"github.com/kiokuless/nuclei/v3/pkg/catalog"
	"github.com/kiokuless/nuclei/v3/pkg/catalog/config"
	"github.com/kiokuless/nuclei/v3/pkg/catalog/disk"
	"github.com/kiokuless/nuclei/v3/pkg/catalog/loader"
	"github.com/kiokuless/nuclei/v3/pkg/core"
	"github.com/kiokuless/nuclei/v3/pkg/external/customtemplates"
	"github.com/kiokuless/nuclei/v3/pkg/input"
	parsers "github.com/kiokuless/nuclei/v3/pkg/loader/workflow"
	"github.com/kiokuless/nuclei/v3/pkg/output"
	"github.com/kiokuless/nuclei/v3/pkg/progress"
	"github.com/kiokuless/nuclei/v3/pkg/projectfile"
	"github.com/kiokuless/nuclei/v3/pkg/protocols"
	"github.com/kiokuless/nuclei/v3/pkg/protocols/common/automaticscan"
	"github.com/kiokuless/nuclei/v3/pkg/protocols/common/contextargs"
	"github.com/kiokuless/nuclei/v3/pkg/protocols/common/globalmatchers"
	"github.com/kiokuless/nuclei/v3/pkg/protocols/common/hosterrorscache"
	"github.com/kiokuless/nuclei/v3/pkg/protocols/common/interactsh"
	"github.com/kiokuless/nuclei/v3/pkg/protocols/common/protocolinit"
	"github.com/kiokuless/nuclei/v3/pkg/protocols/common/uncover"
	"github.com/kiokuless/nuclei/v3/pkg/protocols/common/utils/excludematchers"
	"github.com/kiokuless/nuclei/v3/pkg/protocols/headless/engine"
	httpProtocol "github.com/kiokuless/nuclei/v3/pkg/protocols/http"
	"github.com/kiokuless/nuclei/v3/pkg/protocols/http/httpclientpool"
	"github.com/kiokuless/nuclei/v3/pkg/reporting"
	"github.com/kiokuless/nuclei/v3/pkg/templates"
	"github.com/kiokuless/nuclei/v3/pkg/types"
	"github.com/kiokuless/nuclei/v3/pkg/utils"
	"github.com/kiokuless/nuclei/v3/pkg/utils/stats"
	"github.com/kiokuless/nuclei/v3/pkg/utils/yaml"
